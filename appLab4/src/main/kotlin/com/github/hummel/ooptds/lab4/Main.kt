package com.github.hummel.ooptds.lab4

import com.github.hummel.ooptds.lab4.optional.Improvable
import com.github.hummel.ooptds.lab4.transport.Transport
import com.github.hummel.ooptds.lab4.utils.JsonUtils
import com.github.hummel.ooptds.lab4.utils.StandardUtils
import java.io.File
...
object Shop {
	...
	fun init() {
		...
		plugin?.let {
			try {
				...
				val clazz = classLoader.loadClass("com.github.hummel.ooptds.plugin.Loader")
	...
	private fun addTransport() {
		...
		val clazz = StandardUtils.accessClass("com.github.hummel.ooptds.lab4.transport.$className", "plugin.$className")
		clazz?.let {
