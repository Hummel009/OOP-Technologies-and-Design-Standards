...
import com.github.hummel.ooptds.lab3.transport.CarLadaImproved
import com.github.hummel.ooptds.lab3.transport.CarVolkswagenImproved
...
object JsonUtils {
	...
	fun deserialize() {
		val gson: Gson = GsonBuilder().registerTypeHierarchyAdapter(Transport::class.java, Serializer()).create()
